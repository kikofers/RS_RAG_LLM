...
Directed Graph's structure:
 * Nodes: id, label (the same as id), interval (empty), name, latitude, longitude.
 * Edges: source node, target node, type (directed), id, label (empty), interval (empty), weight, routes (comma-separated list of route_short_names), types (comma-separated list of route_types).
"""
